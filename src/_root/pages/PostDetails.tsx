...
// This page is loaded after the user clicks on a specific post
/* It displays the donation post in a different format from post card and allows users to do the following actions on each post:
      ...
      - Delete the donation post (If the post is owned by the current user)
*/
const PostDetails = () => {
